...
class PoliticsNow extends StatefulWidget {
  const PoliticsNow({super.key});

  @override
  State<PoliticsNow> createState() => _PoliticsNowState();
}

class _PoliticsNowState extends State<PoliticsNow> {
  @override
