...
class CareerLifeHacks extends StatefulWidget {
  const CareerLifeHacks({super.key});

  @override
  State<CareerLifeHacks> createState() => _CareerLifeHacksState();
}

class _CareerLifeHacksState extends State<CareerLifeHacks> {
  @override
